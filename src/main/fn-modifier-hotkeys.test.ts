...
import { FnModifierHotkeys, resolveFnModifierHotkeysExecutablePath } from './fn-modifier-hotkeys'
...
describe('FnModifierHotkeys', () => {
  ...
  it('parses complete and split shortcut lines without accepting other output', async () => {
    ...
    expect(trigger.mock.calls).toEqual([['control'], ['shift'], ['option'], ['command']])
